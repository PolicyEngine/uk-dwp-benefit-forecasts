...
st.markdown("This interactive dashboard shows the forecasted caseloads and spending for different benefits by the Department for Work and Pensions' annual data releases, which can be found [here](https://www.gov.uk/government/collections/benefit-expenditure-tables).")
...
benefit = st.selectbox("Select a benefit", benefits)
